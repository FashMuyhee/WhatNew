...
class EntertainmentScreen extends Component {
  ...
  _fetchLatest = () => {
    axios({
      method: "get",
      url: `https://newsapi.org/v2/top-headlines?country=ng&apiKey=aa584c99aaa247f6a19a428f75a4e9bf&pageSize=5&category=entertainment`,
      timeout: 10000
    })
      .then(res => {
  ...
  _fetchRelated = () => {
    ...
    axios({
      method: "get",
      url: `https://newsapi.org/v2/top-headlines?apiKey=aa584c99aaa247f6a19a428f75a4e9bf&page=${page}&country=ng&category=entertainment`,
      timeout: 10000
    })
      .then(res => {
        alert(res.data.articles);
...
export default withTheme(EntertainmentScreen);
